...
const analyzeReportSchema = z.object({
  image: z
    ...
    .max(50 * 1024 * 1024, 'image payload is too large (max 50MB)'),
  mimeType: z
...
const inviteStaffSchema = z.object({
  ...
  role:      z.enum(['administrator', 'manager', 'receptionist', 'technician']),
});

const updateStaffSchema = z.object({
  role:      z.enum(['administrator', 'manager', 'receptionist', 'technician']).optional(),
  is_active: z.boolean().optional(),
});

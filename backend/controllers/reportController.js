...
async function updateStatus(req, res) {
  ...
  // Only administrator can release
  if (newStatus === 'released' && req.user.role !== 'administrator') {
    return res.status(403).json({ error: 'Only administrators can release reports.' });
  }

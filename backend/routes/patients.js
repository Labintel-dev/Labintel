...
router.post('/',   checkRole('manager', 'receptionist'),
                   validateBody(createPatientSchema),                 ctrl.createPatient);

router.get('/:id',                                                    ctrl.getPatient);
router.put('/:id', checkRole('manager', 'receptionist'),
...
router.get('/:id/alerts',   checkRole('manager'),    ctrl.getPatientAlerts);
router.put('/:id/alerts/:alertId', checkRole('manager'), ctrl.resolveAlert);

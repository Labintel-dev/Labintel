 ...
 *  - 6 staff (3 per lab: 1 admin, 1 receptionist, 1 technician)
...
async function seedStaff(labs) {
  ...
  const staffDefs = [
    // testlab
    { lab: 'testlab',   email: 'admin@sunrise.in',      name: 'Arjun Sharma',   role: 'administrator',  pw: 'Admin@1234' },
    ...
    // secondlab
    { lab: 'secondlab', email: 'admin@citydiag.in',     name: 'Sunita Mehta',   role: 'administrator',  pw: 'Admin@5678' },
...
async function seed() {
  ...
  try {
    ...
    console.log('  testlab admin:   admin@sunrise.in / Admin@1234');
    console.log('  testlab recept:  recept@sunrise.in / Recept@1234');
    console.log('  testlab tech:    tech@sunrise.in / Tech@1234');
    console.log('  secondlab admin: admin@citydiag.in / Admin@5678');
